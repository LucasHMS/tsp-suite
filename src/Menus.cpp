...
int menu_principal(void)
{
  ...
  do {
    ...
    printf("                2. Descida com Best Improvement\n");
    ...
    printf("               15. Descida com Best Improvement (vizinhanca de adjacencia)\n");
    printf("               16. Descida Randomica (vizinhanca de adjacencia)\n");
    printf("               17. Descida com Primeiro de Melhora (vizinhanca de adjacencia)\n");
    printf("                0. Sair \n");
    printf("                Escolha: ");
    scanf("%d",&escolha);
